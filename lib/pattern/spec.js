...
describe('mongo/pattern', () => {
    ...
    describe('db_name', () => {
        test('Should extract db_name', () => {
            const [, match] = db_name.exec('command db_name.collection_name');
            expect(match).toEqual('db_name');
        });
    });
